...
export default function ScenarioDirectorPage() {
  ...
  const [caseFile, setCaseFile] = useState<ScenarioCase>(() => dailyQueue[2].case);
        ...
        <div className="relative z-10 grid gap-6 lg:grid-cols-[1fr_360px] lg:items-end">
          <div>
            <div className="flex flex-wrap items-center gap-3">
              ...
              <span className="technical text-xs uppercase tracking-[0.32em] text-lime">Scenario Director</span>
            </div>
            <h1 className="mt-5 max-w-4xl text-4xl font-semibold tracking-normal text-ink sm:text-6xl">
              Generate a case. Investigate the evidence. Get graded.
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-7 text-zinc-300">
              Scenario Director turns AdverSim into a living SOC training lab. Every case is safe, synthetic, and randomized from defensive templates, so learners practice reasoning instead of watching a fixed ending.
            </p>
          </div>
        ...
        <div className="space-y-5">
          <GlassCard>
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-base font-semibold text-ink">Case Generator</p>
        ...
        <div className="space-y-5">
          <GlassCard>
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                <p className="technical text-xs uppercase tracking-[0.24em] text-lime">{caseFile.case_id}</p>
                <h2 className="mt-2 text-3xl font-semibold text-ink">{caseFile.title}</h2>
                <p className="mt-3 max-w-3xl text-sm leading-6 text-zinc-300">{caseFile.case_briefing}</p>
              </div>
            ...
            <div className="mt-5 rounded-[18px] border border-line bg-white/[0.035] p-4">
              <div className="flex items-center gap-2 text-lime">
                ...
                <p className="technical text-xs uppercase tracking-[0.22em]">Investigation prompt</p>
              </div>
